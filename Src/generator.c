...
int main()
{
    ...
    int id_semafora = alokujSemafor(klucz, 5, 0);
...
#else
    const char *tryb_generatora = "NORMALNY";
#endif
    LOG_GENERATOR_BOTH("Wpuszczam %d procesow (tryb generatora: %s)", liczba_klientow, tryb_generatora);
